...
const deleteHandler = async (id) => {
  ...
  return (
     ...
     <div className="lecture-page">
        ...
        <div className="right">
            {user && user.role==="admin" && (<button onClick={()=>setShow(!show)} className="common-button">
            ...
            }
            {
               lectures && lectures.length>0 ? lectures.map((e,i)=>(
                <>
                    ...
                    {
                       user && user.role ==="admin" && (<button onClick={()=>deleteHandler(e._id)} className="common-button" style={{background:"#f00058"}}>Delete {e.title}</button>)
                    }
                </>
               )) : <p>No Lectures Yet!</p> 
            }
